...
33. Si hay una columna de area, lugar, frente, trabajo, mina, tujo, rio u otro nombre similar, usa key "destino" y label "Area/Lugar".
...
Formato esperado:
{
  ...
  "columnas_detectadas": [
    ...
    { "key": "destino", "label": "Area/Lugar", "original": "Mina/Tujo/Rio" }
  ],
