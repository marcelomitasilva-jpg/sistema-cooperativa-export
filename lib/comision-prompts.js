...
${
  orientacion === "auto_180"
    ? `El sistema puede enviarte cada pagina en pares: primero la imagen original y luego la misma imagen girada 180 grados. No son paginas diferentes. Elige la version donde la cabecera y las columnas se lean mejor.`
...
Devuelve SOLO JSON valido:
{
  ...
  "analisis_tabla": {
    "orientacion_imagen": "derecha | girada | de_lado | cabeza_abajo | dudosa",
    "version_elegida": "original | girada_180 | unica | dudosa",
...
${
  orientacion === "auto_180"
    ? `El sistema puede enviarte cada pagina en pares: original y girada 180 grados. Usa la version_elegida indicada en el mapa y NO dupliques filas.`
    : `Usa la orientacion seleccionada por el usuario: ${orientacion}.`
}
